...
from unique_persona_tags import persona_tags_100 as NEW_PERSONA_TOKENS # get new tokens for each persona

MODEL_NAME  = 'baseline_named_100'
...
def train():
    ...
    parser.add_argument("--dataset_path", type=str, default="../data/consolidated_100", help="Path or url of the dataset. If empty download from S3.")
    parser.add_argument("--dataset_cache", type=str, default='../data/consolidated_100', help="Path or url of the dataset cache")
    ...
    def update(engine, batch):
        ...
        (lm_loss), (mc_loss), *_ = model(
            ...
            mc_labels=mc_labels, labels=lm_labels, return_dict=False
        )
    ...
    def inference(engine, batch):
        ...
        with torch.no_grad():
            ...
            return (lm_logits_flat_shifted, mc_logits, loss), (lm_labels_flat_shifted, mc_labels)
    ...
    metrics = {"nll": Loss(torch.nn.CrossEntropyLoss(ignore_index=-100), output_transform=lambda x: (x[0][0], x[1][0])),
               ...
               "evaluation_loss": RunningAverage(output_transform=lambda x: x[0][2])
               }
